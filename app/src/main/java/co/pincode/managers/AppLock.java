...
public abstract class AppLock {
    ...
    /**
     * EXTRA_TYPE, uses to pass to the {@link co.pincode.managers.AppLockActivity}
     ...
     * take into account for the {@link co.pincode.PinActivity}. These activities
     * will not log the last opened time, will not launch the
     * {@link co.pincode.managers.AppLockActivity} etc...
     */
    ...
    /**
     * Get logo resource id used by {@link co.pincode.managers.AppLockActivity}
     */
    public abstract int getLogoId();

    /**
     * Set logo resource id used by {@link co.pincode.managers.AppLockActivity}
     */
    public abstract void setLogoId(int logoId);

    /**
     * Enable the {@link co.pincode.managers.AppLock} by setting
     * {@link co.pincode.managers.AppLockImpl} as the
     * {@link co.pincode.interfaces.LifeCycleInterface}
     */
    public abstract void enable();

    /**
     * Disable the {@link co.pincode.managers.AppLock} by removing any
     * {@link co.pincode.interfaces.LifeCycleInterface}
     */
    ...
    /**
     * Disable the {@link co.pincode.managers.AppLock} by removing any
     * {@link co.pincode.interfaces.LifeCycleInterface} and also delete
     ...
     * Set in {@link co.pincode.interfaces.LifeCycleInterface#onActivityPaused(android.app.Activity)}
     * and {@link co.pincode.interfaces.LifeCycleInterface#onActivityResumed(android.app.Activity)}
     */
     ...
     * {@link co.pincode.encryption.Encryptor} class.
     */
    ...
    /**
     * Evaluates if:
     * - we are already into the {@link co.pincode.managers.AppLockActivity}
     * - the passcode is not set
     * - the timeout didn't reached
     * If any of this is true, then we don't need to start the
     * {@link co.pincode.managers.AppLockActivity} (it returns false)
