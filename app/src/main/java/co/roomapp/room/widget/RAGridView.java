 ...
 *
 */
public class RAGridView extends android.widget.GridView implements OnScrollListener, android.widget.AdapterView.OnItemClickListener
{
    ...
    public RAGridView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }
    public RAGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
...
//en el fakeAdapter
    ...
    public class mListAdapter extends BaseAdapter
    {
        ...
        public int getCount()
        {
            return originalAdapter.getCount() > 0 ? originalAdapter.getCount() + RAGridView.this.getNumColumnsCompat() : 0;
        }
        @Override
        public Object getItem(int position)
        {
            return originalAdapter.getItem(position + RAGridView.this.getNumColumnsCompat());
        }
        @Override
        public long getItemId(int position)
        {
            return originalAdapter.getItemId(position + RAGridView.this.getNumColumnsCompat());
        }
        ...
        {
            if ( position < RAGridView.this.getNumColumnsCompat() )
            {
        ...
        public View getView(int position, View convert, ViewGroup parent)
        {
            if ( position < RAGridView.this.getNumColumnsCompat() )
            {
                ...
                int realPosition = position - RAGridView.this.getNumColumnsCompat();
...
//repintado, entonces llama a drawHeaders y así....
    ...
    public void onItemClick(AdapterView<?> adapter, View view, int position, long id)
    {
        ...
        {
            clickListenerFromActivity.onItemClick(adapter, view, position - RAGridView.this.getNumColumnsCompat(), id);
        }
    }
}